...
import 'package:closrauth/widgets/bluetooth_widget.dart';
...
class _BluetoothScreenState extends State<BluetoothScreen> {
  ...
  _startScan() {
    _scanSubscription = _flutterBlue
      ...
      print('manufacturerData: ${scanResult.advertisementData.serviceData}');
      setState(() {
  ...
  _connect(BluetoothDevice d) async {
    device = d;
    deviceConnection =
        _flutterBlue.connect(device, timeout: Duration(seconds: 4)).listen(
              null,
              onDone: _disconnect,
            );
